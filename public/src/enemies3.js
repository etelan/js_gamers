class Enemy {
  ...
  createEnemy() {
    ...
    enemy.style.backgroundImage = "url('../images/enemy14.gif')";
    document.getElementById("container").appendChild(enemy);
  }
}

var level_1_enemies = [new Enemy(300,300),new Enemy(300,350),new Enemy(100,100),new Enemy(500,100),new Enemy(100,300)];
